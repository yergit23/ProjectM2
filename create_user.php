...
if(is_not_admin()) {
    set_flash_message("danger", "Вы не являетесь администратором");
    redirect_to("login.php");
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form enctype="multipart/form-data" action="createuser.php" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pjob" id="simpleinput" class="form-control">
                                </div>
