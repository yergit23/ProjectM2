...
if (is_author($_SESSION['log_in_id'], $id) || isset($_SESSION['admin'])) {
    set_flash_message("info", "Вы редактируете профиль");
} else {
    set_flash_message("danger", "Вы редактируете не свой профиль или у Вас нет прав администратора.");
    redirect_to("users.php");
}
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="username" value="<?php echo $user['name']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="pjob"value="<?php echo $user['position']; ?>">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input type="text" id="simpleinput" class="form-control" name="tel" value="<?php echo $user['tel']; ?>">
                                </div>
