...
if (is_author($_SESSION['log_in_id'], $id) || isset($_SESSION['admin'])) {
    set_flash_message("info", "Вы обновляете эл. адрес и пароль");
} else {
    set_flash_message("danger", "Вы обновляете не свой данные или у Вас нет прав администратора.");
    redirect_to("users.php");
}
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
        <a class="navbar-brand d-flex align-items-center fw-500" href="users.php"><img alt="logo" class="d-inline-block align-top mr-2" src="img/logo.png">Проект М</a> <button aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-target="#navbarColor02" data-toggle="collapse" type="button"><span class="navbar-toggler-icon"></span></button>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="securityuser.php" method="post">
            <div class="row">
                <div class="col-xl-6">
