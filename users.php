...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
            <a class="navbar-brand d-flex align-items-center fw-500" href="users.php"><img alt="logo" class="d-inline-block align-top mr-2" src="img/logo.png">Проект</a> <button aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-target="#navbarColor02" data-toggle="collapse" type="button"><span class="navbar-toggler-icon"></span></button>
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php echo $user['status'];?> mr-3">
                                    ...
                                    <span class="rounded-circle profile-image d-block" style="background-image:url('img/demo/avatars/avatar-m.png'); background-size: cover;">
                                    </span>
                                    <?php else: ?>
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $user['img'];?>'); background-size: cover;">
                                    </span>
                                    <?php endif; ?>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="users.php?id=<?php echo $user['id'];?>" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?php echo $user['name'];?>
                                        <?php if (isset($_SESSION['admin'])): ?>
                                        <i class="fal fas fa-cog fa-fw d-inline-block ml-1 fs-md"></i>
                                        <i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                        <?php elseif ($user['email']==$_SESSION['log_in']): ?>
                                        <i class="fal fas fa-cog fa-fw d-inline-block ml-1 fs-md"></i>
                                        <i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                        <?php endif; ?>
                                    </a>
                                    <?php if (isset($_SESSION['admin']) || $user['email']==$_SESSION['log_in']): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if ($user['email']==$_SESSION['log_in']): ?>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="edit.php?id=<?php echo $user['id']; ?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <a href="<?php echo $user['insta'];?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="<?php echo $user['telega'];?>" class="mr-2 fs-xxl" style="color:#E1306C">
