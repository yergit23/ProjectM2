...
if (is_author($_SESSION['log_in_id'], $id) || isset($_SESSION['admin'])) {
    set_flash_message("info", "Вы обновляете статус пользователя");
} else {
    set_flash_message("danger", "Вы обновляете не свой статус или у Вас нет прав администратора.");
    redirect_to("users.php");
}
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" id="example-select">
                                                ...
                                                <?php if($user['statusnew'] == $status['id']): ?>
